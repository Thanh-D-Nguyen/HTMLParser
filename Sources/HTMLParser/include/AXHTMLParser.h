...
/** Called when the document parsing ended.
 ...
 @param parser The parser
 */
- (void)parserDidEndDocument:(AXHTMLParser *)parser length: (NSUInteger)len;
 ...
 */
- (void)parser:(AXHTMLParser *)parser foundCharacters:(NSString *)string range:(NSRange)range;
